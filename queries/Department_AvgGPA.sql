SELECT
    d.DepartmentName,
    ROUND(AVG((ag.NumberAPlus * 4.0 + ag.NumberA * 4.0 + ag.NumberAMinus * 3.67 +
         ...
         ag.NumberF * 0) /
         NULLIF(ag.NumberAPlus + ag.NumberA + ag.NumberAMinus +
